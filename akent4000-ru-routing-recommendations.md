...
Обновлено: 2026-09-04 (после merge `feature/stale-source-quarantine` в main, коммит `6faf07e`)
...
Итоговое ревью ветки (см. ниже, новый пункт P0#2) выявило один открытый риск, требующий отдельного решения — см. следующий пункт.
