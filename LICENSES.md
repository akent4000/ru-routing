...
| [runetfreedom/russia-v2ray-rules-dat](https://github.com/runetfreedom/russia-v2ray-rules-dat) | blocked, RU-inside, RU-outside, and RU domain categories | [GNU GPL v3.0](https://github.com/runetfreedom/russia-v2ray-rules-dat/blob/main/LICENSE), detected by GitHub as `GPL-3.0`. The registry records `GPL-3.0-only`; no separate `-or-later` grant was found in the repository. | runetfreedom/russia-v2ray-rules-dat contributors |
...
| [Loyalsoldier/v2ray-rules-dat](https://github.com/Loyalsoldier/v2ray-rules-dat) | RU and global GeoIP categories | [GNU GPL v3.0](https://github.com/Loyalsoldier/v2ray-rules-dat/blob/master/LICENSE), detected by GitHub as `GPL-3.0`. The registry records `GPL-3.0-only`; no separate `-or-later` grant was found in the repository. | Loyalsoldier/v2ray-rules-dat contributors |
